                        ...
                        <div class="card mb-4 bg-dark text-white">
                            <div class="card-header">
                                <h3 class="card-title text-center">
                                    ...
                                    </span><?=htmlspecialchars($trip['arrival_adress']) ?>
                                </h3>
                            </div>
                            <div class="card-body">
                                <p class="card-text">
                                ...
                                <div class="d-flex align-items-start justify-content-between w-50 my-2">
                                    <span class="badge rounded-pill text-white text-bg-primary">
                                        <img src="<?=htmlspecialchars($trip['energy_icon']); ?>" alt="">
                                    </span>
                                    <span class="badge rounded-pill text-white text-bg-primary">
                                    <?php $smokingIcon = $trip['smoking_icon'] ?? '/assets/icons/no-smoking.svg'; ?>
                                        <img src="<?=htmlspecialchars($smokingIcon); ?>" alt="">
                                    </span>
                                    <span class="badge rounded-pill text-white text-bg-primary">
                                    <?php $petsIcon = $trip['pets_icon'] ?? '/assets/icons/no-pets.svg'; ?>
                                        <img src="<?=htmlspecialchars($petsIcon); ?>" alt="">
                                    </span>
                                </div>
                                <p class="card-text">
                                ...
                                <div class="d-flex justify-content-between align-items-end mt-3">
                                    <a href="/carshare/<?= $trip['carshare_id'] ?>" class="btn btn-primary m-0">Voir le voyage</a>
                                    <?php
                                        $statut = $trip['statut'];
