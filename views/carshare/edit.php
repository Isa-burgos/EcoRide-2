    ...
    <section class="conteneur">
                    ...
                    <div class="step-content">
                        <fieldset class="mb-5">
                            ...
                            <div class="input-container">
                                ...
                                <input class="input form-control startAdress" type="text" value="<?= htmlspecialchars($carshare->getDepartAdress()) ?>" id="depart_adress" name="depart_adress" placeholder="Adresse de départ" required>
                        ...
                        <fieldset class="mb-3">
                            ...
                            <div class="input-container">
                                ...
                                <input class="input form-control endAdress" type="text" value="<?= htmlspecialchars($carshare->getArrivalAdress()) ?>" id="arrival_adress" name="arrival_adress" placeholder="Adresse d'arrivée" required>
                                <div class="suggestions-container"></div>
                                    ...
                                    <?php if(!empty($userVehicles)) : ?>
                                        <?php foreach($userVehicles as $v) : ?>
                                            <?php
                                                ...
                                                $custom = $prefs['custom'] ?? '';
                                                $isSelected = $carshare->getUsedVehicle() == $v->getVehicleId();
                                            ?>
                                ...
                                <div>
                                    <div>
                                        <div>
                                            ...
                                            <input class="input form-control" name="depart_date" id="depart_date" type="date" value="<?= htmlspecialchars($carshare->getDepartDate()) ?>" required>
                                        </div>
                                        <div>
                                            <fieldset>
                                                <legend>Heure</legend>
        ...
        <!-- START STEP 5 -->
                    ...
                    <div id="step5" class="step">
                        ...
                        <div class="step-buttons">
                            <button type="button" class="btn btn-prev mx-2">Étape précédente</button>
                            <input type="submit" value="Mettre à jour" name="saveAnnonce" class="btn btn-submit mx-2">
                        </div>
                    </div>
        <!-- END STEP 5 -->
            </form>
