...
<main class="mb-5">
    ...
    <div class="big-hero-content">
        ...
        <div class="search container w-100">
            <form class="row row-cols-1 row-cols-lg-4 my-2" method="GET" action="/carshare/search">
                ...
                <div class="input-container gx-1 mb-2">
                    <input class="date-depart input" type="date" name="depart_date" placeholder="Date de départ">
                </div>
                <div class="input-container gx-1 mb-2">
...
<section class="trip text-center">
    ...
    <a href="/carshare/create" class="btn">Proposer un trajet</a>
</section>

<section class="about text-center">
    <div>
        <h2>Qui sommes-nous ?</h2>
        <div class="about-paragraph row mx-auto">
