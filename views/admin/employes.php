<h1 class="text-dark mb-5">Employés</h1>

<section class="container">
    <h2 class="text-dark mb-4">Créer un nouvel employé</h2>
    ...
    <?= csrfField(); ?>
        <div class="container row g-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control bg-white" id="name" name="name" value="" required>
            </div>
            <div class="col-md-6">
                <label for="firstname" class="form-label text-dark">Prénom</label>
                <input type="text" class="form-control bg-white" id="firstname" name="firstname" value="" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12">
                <label for="adress" class="form-label text-dark">Adresse</label>
                <input type="text" class="form-control bg-white" id="adress" name="adress"required>
            </div>
            <div class="col-12">
                <label for="phone" class="form-label text-dark">Téléphone</label>
...
<section class="container">
    <h2 class="text-dark mb-4">Liste des employés</h2>
            ...
            <div class="card mb-3 bg-white" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4 text-center my-auto">
                        <h3 class="text-dark"><span class="text-uppercase text-dark"><?= htmlspecialchars($employe->getName()) ?></span><br><?= htmlspecialchars($employe->getFirstname()) ?></h3>
                    </div>
                    <div class="col-md-6">
                        <div class="card-body">
